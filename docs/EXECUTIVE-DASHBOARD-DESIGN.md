...
6. **Control drill-down** — the 147-requirement register remains available through progressive disclosure.
...
- **Red `#B64A4A`**: blocked items only; it is not used to invent risk severity.
...
| Blocked | Red | A named dependency prevents progress |
