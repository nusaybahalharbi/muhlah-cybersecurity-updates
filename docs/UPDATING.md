...
2. Update the relevant operational record in `data/dashboard.ts` or SAMA record in `data/sama-controls.json`.
3. Keep uncertain SAMA conclusions as `Requires Evidence / Verification`; keep unassessed risk fields as `Unrated`.
